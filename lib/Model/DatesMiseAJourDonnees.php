...
class DatesMiseAJourDonnees implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $date_derniere_mise_a_disposition Date et heure (aaaa-mm-jjThh:mm:ss) de la dernière mise à disposition des données de la collection
     *
     * @return $this
     */
     ...
     *
     * @param string $date_dernier_traitement_maximum Date (aaaa-mm-jjThh:mm:ss) correspondant à la date de validité des données consultées
     *
     * @return $this
     */
     ...
     *
     * @param string $date_dernier_traitement_de_masse Date (aaaa-mm-jj) du dernier traitement de masse sur la collection. À cette date plusieurs centaines de milliers de documents ont pu être mis à jour. Il est conseillé de traiter cette date d'une manière spécifique
     *
     * @return $this
     */
