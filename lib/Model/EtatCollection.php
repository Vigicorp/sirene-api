...
class EtatCollection implements ModelInterface, ArrayAccess
{
    ...
    const ETAT_COLLECTION_UP = 'UP';
    const ETAT_COLLECTION_DOWN = 'DOWN';
     ...
     * @return string[]
     */
    public function getEtatCollectionAllowableValues()
    {
        return [
            self::ETAT_COLLECTION_UP,
            self::ETAT_COLLECTION_DOWN,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getEtatCollectionAllowableValues();
        if (!is_null($this->container['etat_collection']) && !in_array($this->container['etat_collection'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'etat_collection', must be one of '%s'",
     ...
     *
     * @param string $etat_collection Etat du service
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getEtatCollectionAllowableValues();
        if (!is_null($etat_collection) && !in_array($etat_collection, $allowedValues, true)) {
