...
> \Sirene\Client\Model\ReponseUnitesLegales findByGetUniteLegale($q, $date, $champs, $masquer_valeurs_nulles, $facette_champ, $tri, $nombre, $debut, $curseur)
...
> \Sirene\Client\Model\ReponseUnitesLegales findByPostUniteLegale($q, $date, $champs, $nombre, $debut, $masquer_valeurs_nulles, $tri, $curseur, $facette_champ)
