...
**date_dernier_traitement_unite_legale** | **string** | Date de la dernière mise à jour effectuée au répertoire Sirene sur le Siren concerné, format AAAA-MM-JJTHH:MM:SS.MMM | [optional] 
...
**societe_mission_unite_legale** | **string** | Appartenance de l’unité légale au champ societé à mission | [optional] 
